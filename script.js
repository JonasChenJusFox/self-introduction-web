...
const translations = {
  en: {
    ...
    "projects.title": "Main projects I actively maintain and present",
    "projects.copy":
      "These three projects best represent my internship experience, full-stack delivery, and longer-term research-oriented software work",
    "projects.kyg.label": "Website Development Internship · Private",
    "projects.kyg.copy":
    ...
    "timeline.kyg.copy":
      "A private website development internship project focused on production website delivery and iterative business-facing implementation",
    "timeline.nearbite.date": "Jan 21 - May 1",
    "timeline.cho": "Prof. Kyunghyun Cho",
    ...
    "timeline.amos": "Prof. Amos Bloomberg",
    ...
    "timeline.catch.copy":
      "A final software engineering project integrating backend services, frontend workflows, and team-grade delivery",
    "timeline.openRepository": "Open repository",
    "contact.label": "Open to Software Engineering Roles",
    "contact.title": "Feel free to contact me!",
    "contact.copy":
  ...
  zh: {
    ...
    "projects.label": "主要项目",
    "projects.title": "持续更新和展示的项目",
    "projects.copy": "这三个项目集中体现了我运用 Cloudflare Workers/D1/R2、Docker、MongoDB、FastAPI 和 React/Vite 完成全栈开发、服务集成与生产级部署的实践能力",
    "projects.kyg.label": "网站开发实习",
    "projects.kyg.copy":
    ...
    "timeline.cho": "Prof. Kyunghyun Cho",
    "timeline.nearbite.copy": "长期机器学习项目，关注实际软件交付、持续迭代和研究型产品思维",
    "timeline.fitflow.date": "2 月 12 日 - 3 月 15 日",
    "timeline.amos": "Prof. Amos Bloomberg",
    "timeline.fitflow.copy": "Web 应用项目，强调产品流程、前端结构和清晰的用户行为",
    "timeline.pypl.date": "3 月 10 日 - 3 月 31 日",
    "timeline.pypl.copy": "Pypl项目，关注可安装结构、可维护模块和可复用游戏逻辑",
    ...
    "timeline.catch.copy": "软件工程全栈项目，整合后端服务、前端工作流和团队级交付",
